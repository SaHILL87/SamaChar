  ...
  return (
    <div className="flex flex-col min-h-screen">
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl">
                  Get the latest news from around the world, personalized for you. Fast, reliable, and always up-to-date.
                </p>
              </div>
              <div className="space-x-4">
                <Link to="/login">
                  <Button variant="outline" className="bg-black text-white hover:bg-white hover:text-black hover:border-black">Login</Button>
                </Link>
                <Link to="/register">
                  <Button variant="outline" className="hover:bg-gray-600 hover:text-white">Register</Button>
                </Link>
              </div>
            </div>
          </div>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-3">
              <div className="flex flex-col items-center space-y-3 text-center">
                ...
                <p className="text-sm text-gray-500">Stay on top of the most discussed topics</p>
              </div>
              <div className="flex flex-col items-center space-y-3 text-center">
                <Globe className="h-10 w-10" />
                <h3 className="text-xl font-bold">Global Coverage</h3>
                <p className="text-sm text-gray-500">News from every corner of the world</p>
              </div>
              <div className="flex flex-col items-center space-y-3 text-center">
                <User className="h-10 w-10" />
                <h3 className="text-xl font-bold">Personalized Feed</h3>
                <p className="text-sm text-gray-500">News tailored to your interests</p>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-3">
              <div className="flex flex-col items-center space-y-3 text-center">
                <img
                  ...
                  width="60"
                />
                <p className="text-sm text-gray-500">"NewsApp has become my go-to source for staying informed. Highly recommended!"</p>
              ...
              <div className="flex flex-col items-center space-y-3 text-center">
                <img
                  ...
                  width="60"
                />
                <p className="text-sm text-gray-500 ">"I love how I can customize my news feed. It's like having a personal news curator."</p>
              ...
              <div className="flex flex-col items-center space-y-3 text-center">
                <img
                  ...
                  width="60"
                />
                <p className="text-sm text-gray-500 ">"The global coverage is impressive. I feel more connected to world events now."</p>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="flex flex-col p-6 bg-white rounded-lg shadow-lg">
                ...
                <p className="text-center text-gray-500 mb-4">For the news enthusiast</p>
              ...
              <div className="flex flex-col p-6 bg-white rounded-lg shadow-lg">
                ...
                <p className="text-center text-gray-500 mb-4">For organizations</p>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-500">© 2024 NewsApp. All rights reserved.</p>
